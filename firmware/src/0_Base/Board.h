...
#define PIN_SPI_FLASH_CS 10 // 硬件 SPI CS  (信息备注)
#define PIN_SPI_MOSI 11     // 硬件 SPI DI  (信息备注)
#define PIN_SPI_MISO 12     // 硬件 SPI DO  (信息备注)
#define PIN_SPI_SCK 13      // 硬件 SPI SCK (信息备注)
