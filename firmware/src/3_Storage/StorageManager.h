...
public:
    ...
    bool GetPersonalCalibBySlot(uint8_t slot, PersonalCalibData_t* data);
    uint8_t GetActiveSlot() const;
    bool UpdatePersonalCalib(const PersonalCalibData_t* data, uint8_t slot = 0xFF);
    ...
    void CZone_FlushCache();  // [FIX] Public cache flush for query consistency
