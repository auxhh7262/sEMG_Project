...
function offCalibData(fn) { if (!fn) return; const i = _calibDataListeners.indexOf(fn); if (i !== -1) _calibDataListeners.splice(i, 1) }
...
function _routeTypedMessage(rawData) {
  ...
  // CMD response with seq: match pending query
